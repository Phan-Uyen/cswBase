...
test("71979 - Drill hole viewer rulers showing incorrect values @drillhole @viewPanel", async ({ }, testInfo) => {
  //set timeout 
  ...
  //user selects layout list 
  await test.step(`User selects layout list`, async () => {
