...
test("COR-27013 - Browser tile bar to display Coreshed Viewer @dashboard", async ({ }, testInfo) => {

  //set timeout 
  test.setTimeout(300000);

  //expect the title of the page is correctly displayed
  await test.step(`expect the title of the page is correctly displayed`, async () => {
    const title = await page.title()
    await expect(title).toContain('Coreshed Viewer');
